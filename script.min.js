let scrollLock=false;function scrollToTopControlled(){if(!scrollLock){scrollLock=true;window.scrollTo({top:0,behavior:'smooth'});setTimeout(()=>{scrollLock=false;},3000);}}const htmlBody=document.querySelector("html, body"),results=document.querySelector("#results"),scrollToResults=()=>{let e=results.offsetTop;htmlBody.scrollTo({top:e,behavior:"smooth"})},searchInput=document.getElementById("search-input"),searchButton=document.getElementById("search-button"),resultsContainer=document.getElementById("results"),corsProxy="https://core-proxy.piyushsingh8373.workers.dev//?url=";function optimisedImageUrl(e){return e.replace("._V1_.","._V1_QL75_UX160_.")}function fetchAndShow(){let e=encodeURIComponent(searchInput.value),t=`${corsProxy}https://v3.sg.media-imdb.com/suggestion/x/${e}.json`;Pace.restart(),fetch(t).then(e=>e.json()).then(e=>{let t=e.d;resultsContainer.innerHTML="",t.forEach(e=>{if(e.i&&("movie"===e.qid||"tvSeries"===e.qid)){let t=document.createElement("div");t.classList.add("result"),t.setAttribute("IMDB",e.id);let i="";"movie"===e.qid&&e.i?i=`<a onClick="setUrl(this); return setVideo(this);" url="imdb=${e.id}&type=movie&title=${e.l.replace(/ /g,"_")}" isWebSeries="false" title="${e.l}"  class="links" IMDB="${e.id}" href="https://www.2embed.cc/embed/${e.id}" target="_blank">
